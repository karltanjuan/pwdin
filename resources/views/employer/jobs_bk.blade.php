...
@section('content')
                            ...
                            <div class="details personal">
                                <div class="fields">
                                    <div class="input-field">
                                        ...
                                        <input id="job_title" class="job_title" type="text"
                                    ...
                                    <div class="input-field">
                                        ...
                                        <input class="years_experience" id="years_experience" type="number"
                                            placeholder="Enter years of experience">
                                        <span class="err-years_experience err-msg"></span>
                                    </div>
                                    <div class="input-field">
                                        <label>Average Processing Days</label>
                                        <input class="average_processing_time" id="average_processing_time" type="number"
                                    ...
                                    <div class="input-field">
                                        ...
                                        <!--gawa ni gail eyy -->
                                        <input type="checkbox" class="hide_salary" name="hide_salary" id="hide_salary"
                                            value="0" {{ $job->hide_salary ? 'checked' : '' }}>
                                    ...
                                    <div class="input-field">
                                        ...
                                        <select class="working_days" id="working_days" name="working_days[]"
                                            multiple="multiple">
                                    ...
                                    <div class="input-field">
                                        ...
                                        <select class="pwd_categories" id="pwd_categories" name="pwd_categories[]"
                                            multiple="multiple">
    ...
    <script>
        ...
        $("input[type='checkbox']:not(.check-all)").click(function() {
            var other_checkbox = ($("input[type='checkbox']:not(.check-all)").length === $(
                "input[type='checkbox']:not(.check-all):checked").length);
