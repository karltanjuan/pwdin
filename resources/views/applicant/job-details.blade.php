                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><i class="fa fa-angle-right text-primary me-2"></i>Average Processing
                                Time:<i>{{ $job->average_processing_time }}</i></li>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                @if (count($job->applications) > 0 && $job->applications[0]->status != 'Withdrawn')
                                    <button class="btn btn-primary btn-lg w-100 btn-withdraw"
